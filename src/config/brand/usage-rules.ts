...
export const interactionRules = [
  ...
  'Font weight: font-black for headings and section titles, font-bold for emphasis and CTA labels, font-semibold for field labels and captions, font-medium for inline body emphasis. Do not use font-extrabold — it has no defined role in the CASA type scale.',
