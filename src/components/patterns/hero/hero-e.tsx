    ...
    <HeroShell spec={spec} className={className} dataTestId={dataTestId}>
      <div className="grid gap-8 lg:grid-cols-[1.06fr_0.94fr]">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-slate-600 sm:text-lg">{spec.subheadline}</p>

          <div className="mt-6 rounded-xl border border-slate-200/80 bg-white px-4 py-3 text-sm text-slate-600 shadow-[var(--shadow-soft)]">
